    ...
    static makeCreateMarketInstruction({ connection, wallet, marketInfo, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            ins2.push(web3_js_1.SystemProgram.createAccountWithSeed({
                ...
                lamports: yield connection.getMinimumBalanceForRentExemption(5084 + 12),
                space: 5084 + 12,
                programId: marketInfo.programId,
            }), web3_js_1.SystemProgram.createAccountWithSeed({
                fromPubkey: wallet,
                ...
                lamports: yield connection.getMinimumBalanceForRentExemption(11308 + 12),
                space: 11308 + 12,
                programId: marketInfo.programId,
            }), web3_js_1.SystemProgram.createAccountWithSeed({
                fromPubkey: wallet,
                ...
                lamports: yield connection.getMinimumBalanceForRentExemption(14524 + 12),
                space: 14524 + 12,
                programId: marketInfo.programId,
            }), web3_js_1.SystemProgram.createAccountWithSeed({
                fromPubkey: wallet,
