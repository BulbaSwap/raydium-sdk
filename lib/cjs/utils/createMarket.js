    ...
    static makeCreateMarketInstruction({ connection, wallet, marketInfo, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            ins1.push(web3_js_1.SystemProgram.createAccountWithSeed({
                ...
                lamports: yield connection.getMinimumBalanceForRentExemption(5084),
                space: 5084,
                programId: marketInfo.programId,
            }), web3_js_1.SystemProgram.createAccountWithSeed({
                fromPubkey: wallet,
                ...
                lamports: yield connection.getMinimumBalanceForRentExemption(11308),
                space: 11308,
                programId: marketInfo.programId,
            }), web3_js_1.SystemProgram.createAccountWithSeed({
                fromPubkey: wallet,
                ...
                lamports: yield connection.getMinimumBalanceForRentExemption(14524),
                space: 14524,
                programId: marketInfo.programId,
            }), web3_js_1.SystemProgram.createAccountWithSeed({
                fromPubkey: wallet,
